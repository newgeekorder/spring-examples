...
set JARPATH=%APP_HOME%\lib\springboot-webmagic-crawler.jar

@rem Execute springboot-webmagic-crawler
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SPRINGBOOT_WEBMAGIC_CRAWLER_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
